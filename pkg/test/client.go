...
func NewFakeClient(t *testing.T, initObjs ...runtime.Object) *FakeClient {
	...
	return &FakeClient{client, t, nil, nil, nil, nil, nil, nil, nil}
}
...
func (c *FakeClient) Status() client.StatusWriter {
	if c.MockStatusUpdate != nil || c.MockStatusPatch != nil {
		u := &mockStatusUpdate{mockUpdate: c.Client.Status().Update, mockPatch: c.Client.Status().Patch}
		if c.MockStatusUpdate != nil {
			u.mockUpdate = c.MockStatusUpdate
		}
		if c.MockStatusUpdate != nil {
			u.mockPatch = c.MockStatusPatch
		}
		return u
	}
